...
function openLearningModule(category) {
    ...
    // Set up modal content with scrollbar
    ...
    learningContentDiv.style.flex = '1';
    learningContentDiv.style.overflowY = 'auto';
    learningContentDiv.style.padding = '1rem';
    learningContentDiv.style.maxHeight = 'calc(90vh - 140px)'; // Account for header and footer
    
    // Add custom scrollbar styling
    learningContentDiv.style.scrollbarWidth = 'thin';
    learningContentDiv.style.scrollbarColor = '#FFD700 #f0f0f0';

    // Add these styles for webkit browsers
    const styleSheet = document.createElement('style');
    styleSheet.textContent = `
        #learningContent::-webkit-scrollbar {
            width: 8px;
        }
        #learningContent::-webkit-scrollbar-track {
            background: #f0f0f0;
            border-radius: 4px;
        }
        #learningContent::-webkit-scrollbar-thumb {
            background: #FFD700;
            border-radius: 4px;
        }
        #learningContent::-webkit-scrollbar-thumb:hover {
            background: #FFC700;
        }
    `;
